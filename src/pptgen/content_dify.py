...
SLIDES = [
    ...
    # ── 16 实战三：工作流节点 ───────────────────────────────
    dict(layout='node_flow', kicker='04 实战三 · 小红书运营一条龙',
         title='工作流总览：8 个节点跑通内容生产线',
         nodes=['Start 收集信息', '生成标题', '生成正文', '生成封面前言',
                '生成封面图', '获取封面图 URL', '组装结果', 'End 结束'],
         note='可视化节点编排：LLM 生成 + HTTP 生图 + 代码处理 + 模板组装，一次运行产出完整内容。',
